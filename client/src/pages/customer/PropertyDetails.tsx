    ...
    <div className="max-w-5xl mx-auto p-6 bg-gray-50 rounded-lg shadow-lg">
      ...
      <div className="mt-6 bg-white p-6 rounded-lg shadow-md">
        ...
        <ul className="mt-2 text-gray-600 space-y-1">
          <li>
            <strong>Build Year:</strong> {formData.basicInfo.buildYear}
          </li>
          <li>
            <strong>Owner Lives Here:</strong>{" "}
            {formData.basicInfo.liveAtProperty ? "Yes" : "No"}
          </li>
          <li>
            <strong>Contact Email:</strong> {formData.basicInfo.contactEmail}
          </li>
          <li>
            <strong>Contact Mobile:</strong> {formData.basicInfo.contactMobile}
          </li>
        </ul>
      </div>
      ...
      <div className="mt-6 bg-white p-6 rounded-lg shadow-md flex justify-between items-center">
        <div>
          ...
          <p className="text-lg text-gray-600">
            ₹{formData.pricing.price} per night
          </p>
          <p
            className={`text-md ${
